    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 text-center max-w-4xl mx-auto">
        <div className="p-6">
          ...
          <p className="text-gray-600">Secure and speedy checkout process with Stripe integration.</p>
        </div>
        <div className="p-6">
          ...
          <p className="text-gray-600">Curated selection of premium tech products for your needs.</p>
        </div>
        <div className="p-6">
          <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-4">
            <ShoppingCart className="w-6 h-6 text-purple-600" />
          </div>
          <h3 className="font-semibold text-gray-900 mb-2">Simple Returns</h3>
          <p className="text-gray-600">Easy return process if you're not completely satisfied.</p>
        </div>
      </div>
    </div>
  );
